...
const DashBoard = ({ children }) => {
    ...
    return (
        <Layout style={{ minHeight: "100vh" }}>
            <Sider width={250} theme="light" collapsed={appContext.collapsed}>
                <div className="logo bg-slate-700 h-20 flex items-center text-center">
                    <img
            ...
            <Layout>
                ...
                <Footer style={{ textAlign: "center" }}>
                    Nobita 2022 Created by Nobita.Pro 
                </Footer>
            </Layout>
        </Layout>
    );
