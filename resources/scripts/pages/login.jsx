        ...
        <div>
            ...
            >
                <div className="flex-1 hidden md:block bg-white px-16 pt-10 rounded-l-xl">
                    ...
                    <div className="mt-32">
                        <h2 className="text-orange-400 font-bold text-3xl mb-3">
                            Check the Status
                        </h2>
                        <p className="mb-5">
                        ...
                        <Space size={"middle"}>
                            <a
                                href="#"
                                className="pt-1 hover:text-orange-400 text-orange-400 "
                            >
                                <FontAwesomeIcon
                                    size="2x"
                ...
                <div className="flex-1 px-16 bg-orange-400 rounded-r-xl relative">
                    <div className="w-1/2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        ...
                        >
                            ...
                            text-orange-400 font-bold text-xl hover:bg-gray-100 hover:text-orange-400
                        "
                                    htmlType="submit"
                                >
                                    Sign in
